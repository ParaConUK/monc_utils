...
.. topic:: New at 0.4.2
    ...
    #. Support for UM-style grid staggering.
    #. Generic derivatives and grid-conforming functions :py:func:`~monc_utils.data_utils.difference_ops.grid_conform_xy`, :py:func:`~monc_utils.data_utils.difference_ops.d_by_dxy_field_native` and :py:func:`~monc_utils.data_utils.difference_ops.d_by_dxy_field` are available for xy direction.
